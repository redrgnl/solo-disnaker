    ...
    <div class="col s12">
      <div id="validation" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form class="col s12" method="post" action="/admin/update-data-role">
            @csrf
            <div class="row">
              <div class="input-field col s12">
                <i class="material-icons prefix">assignment</i>
                <input type="hidden" name="inpid" value="{{ $role->id_role }}">
                <input name="inpnama" id="inpnama" type="text" class="validate" value="{{ $role->nama_role }}">
                <label for="inpnama">Role</label>
                @error('a')
