    ...
    <div class="col s12">
      <div id="validation" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form class="col s12" method="post" action="/perusahaan/update-data-lowongan">
            @csrf
            <input type="hidden" name="inpid" id="inpid" value="{{ $lowongan->id_lowongan }}">
            <div class="row">
              <div class="input-field col s12">
                <i class="material-icons prefix">work</i>
                <input name="b" id="inpposisi" type="text" class="validate"  value="{{ $lowongan->posisi_lowongan }}">
