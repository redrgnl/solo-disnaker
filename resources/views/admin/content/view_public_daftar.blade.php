    ...
    <div id="modal-daftar" class="modal">
      <div class="modal-content">
        ...
        <form class="col s12" method="post" action="/save-perusahaan" name="save_form" id="save_form" enctype="multipart/form-data">
            ...
            <div class="row">
              <div class="input-field col s12">
                <button class="btn waves-effect waves-light gradient-45deg-light-blue-cyan gradient-shadow right text-white" type="submit" name="save_form_button" form="save_form" id="save_form_button">Submit
