...
<div id="modaldelete" class="modal">
  <div class="modal-content">
    ...
    <form method="post" action="/admin/delete-data-detail-lowongan">
      @csrf
    ...
    <table id="page-length-option" class="display">
      ...
      <tbody>
        ...
        @foreach($pelamar as $pl)
          <tr>
            <td>
                <a href="/admin/tambah-pelamar-lowongan/{{ $lowonganID }}/{{ $pl->id_pelamar }}/{{ $perusahaanID }}" class="btn-floating modal-trigger waves-effect waves-light btn gradient-45deg-green-teal gradient-shadow">
