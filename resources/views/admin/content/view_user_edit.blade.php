    ...
    <div class="col s12">
      <div id="validation" class="card card card-default scrollspy">
        <div class="card-content">
          ...
          <form class="col s12" method="post" action="/admin/update-data-pengguna">
            @csrf
            <input type="hidden" name="inpid" value="{{ $user->id_user }}">
            <div class="row">
              <div class="input-field col s12">
                <i class="material-icons prefix">account_circle</i>
                <input name="inpnama" id="inpnama" type="text" class="validate"  value="{{ $user->nama_user }}">
            ...
            <div class="row">
              <div class="input-field col s12 m6 l6">
                <i class="material-icons prefix">account_circle</i>
                <input name="inpusername" id="inpusername" type="text" class="validate"  value="{{ $user->username_user }}">
              ...
              <div class="input-field col s12 m6 l6">
                ...
                <input name="inpemail" id="inpemail" type="email" class="validate"  value="{{ $user->email_user }}">
            ...
            <div class="row">
              <div class="input-field col s12 m6 l6">
                ...
                <select  name="inprole" id="inprole">
                  ...
                  @foreach($role as $rl)
                    <?php if($user->id_role == $rl->id_role) { $selected = "selected"; } else { $selected = ""; }?>
                    <option value="{{ $rl->id_role }}" <?php echo $selected?>>{{ $rl->nama_role }}</option>
                  @endforeach
                </select>
