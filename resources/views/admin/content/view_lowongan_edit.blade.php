          ...
          <form class="col s12" method="post" action="/admin/update-data-lowongan">
            ...
            <div class="row">
              <span class="input-field col s6">
                ...
                <select class="" name="cc" id="inptingkatpdd" >
                  ...
                  <option value="{{ $komp->id_tingkatpdd }}" <?php if($lowongan->jenis_kompetensi_lowongan == $komp->id_tingkatpdd){ echo "selected"; } ?>>{{ $komp->jenis_tingkatpdd }}</option>
                  @endforeach
                </select>
            ...
            <span class="input-field col s6 m6 l6">
              <select class="browser-default" name="n" id="inpjurusan">
                <option value="">- Pilih Jurusan -</option>
                  @foreach($detpdd as $k)
                  <option value="{{ $k->id_det_tingkatpdd }}" <?php if($lowongan->jurusan_pdd_lowongan == $k->id_det_tingkatpdd){ echo "selected"; } ?>>{{ $k->jenis_det_tingkatpdd }}</option>
                  @endforeach
              </select>
              @error('i')
              <span class="helper-text" data-error="wrong" data-success="right" style="color: red">{{ $message }}</span>
            ...
            <div class="input-field col l6 s6">
              ...
              <select class="form-control" name="l" id="sistem_pembayaran_harapan">
                ...
                <option value="BORONGAN" <?php if ($lowongan->sistem_pengupahan_gaji == 'BORONGAN'){ echo "selected"; }?>>BORONGAN</option>
                <option value="HARIAN" <?php if ($lowongan->sistem_pengupahan_gaji == 'HARIAN'){ echo "selected"; }?>>HARIAN</option>
                <option value="MINGGUAN" <?php if ($lowongan->sistem_pengupahan_gaji == 'MINGGUAN'){ echo "selected"; }?>>MINGGUAN</option>
                <option value="BULANAN"<?php if ($lowongan->sistem_pengupahan_gaji == 'BULANAN'){ echo "selected"; }?>>BULANAN</option>
              </select>
              ...
              <div class="input-field col l6 s6">
                ...
                <select name="o" id="o" required>
                  ...
                  <option value="WAKTU TERTENTU" <?php if ($lowongan->status_hubungan_kerja == 'WAKTU TERTENTU'){ echo "selected"; }?>>WAKTU TERTENTU</option>
                  <option value="WAKTU TIDAK TERTENTU" <?php if ($lowongan->status_hubungan_kerja == 'WAKTU TIDAK TERTENTU'){ echo "selected"; }?>>WAKTU TIDAK TERTENTU</option>
                </select>
