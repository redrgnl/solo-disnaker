...
--
-- Table structure for table `tb_data_pelaku_usaha`
--
...
--
-- Dumping data for table `tb_data_pelaku_usaha`
--
...
CREATE TABLE `tb_det_gallery` (
  `id_detgal` int(11) NOT NULL,
  `id_perusahaan` int(11) NOT NULL,
  `nama_detgal` varchar(255) NOT NULL,
  `ket_detgal` text NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 1, 'Dana-5d9ef36ad895c.jpeg', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'),
(2, 1, 'Dana-Dwd85qNWwAAL7ab.jpg', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.'),
(3, 3, 'OVO-TJGS4533.jpg', 'oovo'),
(5, 3, 'OVO-2019_03_20_68085_1553058276._large.jpg', 'sadasd'),
(6, 21, '2020_02_05_07_31_10jpg', 'assdasad');
...
CREATE TABLE `tb_det_tingkatpdd` (
  `id_det_tingkatpdd` int(4) NOT NULL,
  `id_tingkatpdd` int(2) NOT NULL,
  `jenis_det_tingkatpdd` varchar(60) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1101, 11, 'TIDAK TAMAT SD'),
(1102, 11, 'SETINGKAT SD'),
(1103, 11, 'TAMAT SD'),
(1201, 12, 'MADRASAH TSANAWIYAH'),
(1202, 12, 'SEKOLAH MENENGAH PERTAMA'),
(1203, 12, 'SLTP KEJURUAN'),
(1204, 12, 'SLTP - LAINNYA'),
(1301, 13, 'MADRASAH ALIYAH'),
(1302, 13, 'MADRASAH ALIYAH - IPA'),
(1303, 13, 'MADRASAH ALIYAH - IPS'),
(1304, 13, 'SLTA KEJURUAN'),
(1305, 13, 'SMU'),
(1306, 13, 'SMU - IPA'),
(1307, 13, 'SMU - IPS'),
(1308, 13, 'SMU - BAHASA'),
(1309, 13, 'GEOLOGI PERTAMBANGAN'),
(1310, 13, 'GEOMATIKA'),
(1311, 13, 'KIMIA'),
(1312, 13, 'MEKATRONIKA'),
(1313, 13, 'PELAYARAN'),
(1314, 13, 'TEKNIK BANGUNAN'),
(1315, 13, 'TEKNIK ELEKTRONIKA'),
(1316, 13, 'TEKNIK ENERGI TERBARUKAN'),
(1317, 13, 'TEKNIK FURNITUR'),
(1318, 13, 'TEKNIK GRAFIKA'),
(1319, 13, 'TEKNIK INDUSTRI'),
(1320, 13, 'TEKNIK INSTRUMENTASI INDUSTRI'),
(1321, 13, 'TEKNIK KETENAGALISTRIKAN'),
(1322, 13, 'TEKNIK KIMIA'),
(1323, 13, 'TEKNIK LAINNYA'),
(1324, 13, 'TEKNIK MESIN'),
(1325, 13, 'TEKNIK OTOMOTIF'),
(1326, 13, 'TEKNIK PENDINGINAN DAN TATA UDARA'),
(1327, 13, 'TEKNIK PERKAPALAN'),
(1328, 13, 'TEKNIK PERMINYAKAN'),
(1329, 13, 'TEKNIK PLAMBING DAN SANITASI'),
(1330, 13, 'TEKNIK SURVEI DAN PEMETAAN'),
(1331, 13, 'TEKNOLOGI PESAWAT UDARA'),
(1332, 13, 'TEKNOLOGI TEKSTIL'),
(1333, 13, 'TEKNIK BROADCASTING'),
(1334, 13, 'TEKNIK KOMPUTER DAN INFORMATIKA'),
(1335, 13, 'TEKNIK TELEKOMUNIKASI'),
(1336, 13, 'KEPERAWATAN'),
(1337, 13, 'KEPERAWATAN'),
(1338, 13, 'PEKERJAAN SOSIAL'),
(1339, 13, 'DESAIN DAN PRODUKSI KRIYA'),
(1340, 13, 'PARIWISATA'),
(1341, 13, 'SENI KERAWITAN'),
(1342, 13, 'SENI MUSIK'),
(1343, 13, 'SENI PEDALANGAN'),
(1344, 13, 'SENI RUPA'),
(1345, 13, 'SENI TARI'),
(1346, 13, 'SENI TEATER'),
(1347, 13, 'TATA BOGA'),
(1348, 13, 'TATA BUSANA'),
(1349, 13, 'TATA KECANTIKAN'),
(1350, 13, 'USAHA PERJALANAN WISATA'),
(1351, 13, 'AGRIBISNIS PENGOLAHAN HASIL PERTANIAN DAN PERIKANAN'),
(1352, 13, 'AGRIBISNIS PRODUKSI SUMBERDAYA PERAIRAN'),
(1353, 13, 'AGRIBISNIS PRODUKSI TANAMAN'),
(1354, 13, 'AGRIBISNIS PRODUKSI TERNAK'),
(1355, 13, 'KESEHATAN HEWAN'),
(1356, 13, 'MEKANISASI PERTANIAN'),
(1357, 13, 'PENYULUHAN PERTANIAN'),
(1358, 13, 'ADMINISTRASI'),
(1359, 13, 'AKUNTANSI'),
(1360, 13, 'BISNIS DAN MANAJEMEN'),
(1361, 13, 'KEUANGAN'),
(1362, 13, 'MANAJEMEN PERKANTORAN'),
(1363, 13, 'TATA NIAGA'),
(1364, 13, 'PELAYARAN'),
(1365, 13, 'TEKNOLOGI DAN PRODUKSI PERIKANANA BUDIDAYA'),
(1366, 13, 'TEKNOLOGI PENANGKAPAN IKAN'),
(1367, 13, 'USAHA PERJALANAN WISATA'),
(1368, 13, 'SMK - Budidaya Ternak Unggas');
...
CREATE TABLE `tb_harapan_kerja` (
  `id_harapan_kerja` int(6) NOT NULL,
  `id_pelamar_harapan` int(6) NOT NULL,
  `penempatan_harapan` varchar(20) CHARACTER SET latin1 NOT NULL,
  `provinsi_harapan` varchar(10) CHARACTER SET latin1 NOT NULL,
  `kota_harapan` varchar(10) CHARACTER SET latin1 NOT NULL,
  `jabatan_harapan` int(5) NOT NULL,
  `pembayaran_gaji_harapan` varchar(10) CHARACTER SET latin1 NOT NULL,
  `besar_gaji_harapan` int(5) NOT NULL,
  `negara_luar_harapan` varchar(5) CHARACTER SET latin1 NOT NULL,
  `izin_keluarga_harapan` varchar(50) CHARACTER SET latin1 NOT NULL,
...
(1, 'PANGLIMA TNI'),
(2, 'KEPALA STAF UMUM TNI (KASUM TNI)'),
(3, 'INSPEKTUR JENDERAL TNI (IRJEN TNI)'),
(4, 'STAF AHLI PANGLIMA TNI (SAHLI PANGLIMA TNI)'),
(5, 'ASISTEN KEBIJAKAN STRATEGIS DAN PERENCANAAN UMUM PANGLIMA TNI (ASRENUM PANGLIMA TNI)'),
(6, 'ASISTEN INTELIJEN PANGLIMA TNI (ASINTEL PANGLIMA TNI)'),
(7, 'ASISTEN OPERASI PANGLIMA TNI (ASOPS PANGLIMA TNI)'),
(8, 'ASISTEN PERSONALIA PANGLIMA TNI (ASPERS PANGLIMA TNI)'),
(9, 'ASISTEN LOGISTIK PANGLIMA TNI (ASLOG PANGLIMA TNI)'),
(10, 'ASISTEN TERITORIAL PANGLIMA TNI (ASTER PANGLIMA TNI)'),
(11, 'ASISTEN KOMUNIKASI DAN ELEKTRONIKA PANGLIMA TNI (ASKOMLEK PANGLIMA TNI)'),
(12, 'PERWIRA STAF KHUSUS POLISI MILITER (PASSUSPOM TNI)'),
(13, 'KOMANDAN SATUAN KOMUNIKASI DAN ELEKTRONIKA TNI (DANSATKOMLEK TNI)'),
(14, 'KEPALA PUSAT PENGENDALIAN OPERASI TNI (KAPUSDALOPS TNI)'),
(15, 'KEPALA SEKRETARIAT UMUM TNI (KASETUM TNI)'),
(16, 'KOMANDAN SEKOLAH STAF DAN KOMANDO TNI (DANSESKO TNI)'),
(17, 'KOMANDAN KOMANDO PENDIDIKAN DAN LATIHAN TNI (DANKODIKLAT TNI)'),
(18, 'KOMANDAN JENDERAL AKADEMI TNI (DANJEN AKADEMI TNI)'),
(19, 'KEPALA BADAN INTELIJEN STRATEGIS TNI (KABAIS TNI)'),
(20, 'KOMANDAN PASUKAN PENGAMANAN PRESIDEN (DANPASPAMPRES)'),
(21, 'KEPALA BADAN PEMBINAAN HUKUM TNI (KABABINKUM TNI)'),
...
(4, 'COMANDITER VENNOTSCHAAP'),
(5, 'FIRMA'),
(6, 'INSTANSI'),
(7, 'KOPERASI'),
(8, 'PERSEROAN TERBATAS'),
(9, 'PERUSAHAAN PERORANGAN'),
(10, 'PERUSAHAAN YANG MENGGUNAKAN TKA KURANG DARI 10'),
(11, 'PERUSAHAAN YANG MENGGUNAKAN TKA LEBIH DARI 10'),
(12, 'PO*'),
(13, 'YAYASAN');
...
CREATE TABLE `tb_lowongan` (
  ...
  `jml_lowongan_wanita` int(5) NOT NULL,
  `sistem_pengupahan_gaji` varchar(10) NOT NULL,
...
CREATE TABLE `tb_pelamar` (
  ...
  `statuskawin_pelamar` varchar(2) NOT NULL,
  ...
  `kondisi_pelamar` varchar(30) NOT NULL,
  `kewarganegaraan_pelamar` varchar(30) NOT NULL,
  ...
  `id_tingkatpdd` int(2) NOT NULL,
  `id_det_tingkatpdd` int(4) NOT NULL,
  `institusi_pelamar` varchar(100) NOT NULL,
  `tahunlulus_pelamar` varchar(4) NOT NULL,
  `nilai_pelamar` varchar(5) NOT NULL,
  `password_pelamar` varchar(64) NOT NULL,
  `confirm_password_pelamar` varchar(64) NOT NULL,
  `status_pelamar` varchar(9) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tb_perusahaan` (
  ...
  `map_perusahaan` text NOT NULL,
  `id_jenis` int(11) NOT NULL,
  `kelas_perusahaan` varchar(10) NOT NULL,
  `id_provinsi` int(4) NOT NULL,
  `id_kota` int(8) NOT NULL,
  `id_kecamatan` int(10) NOT NULL,
  `lokasi_perusahaan` int(11) NOT NULL,
  `kodepos_perusahaan` int(8) NOT NULL,
  `web_perusahaan` text NOT NULL,
  `desk_perusahaan` text NOT NULL,
  `penanggung_perusahaan` varchar(100) NOT NULL,
  `telp_perusahaan` varchar(15) NOT NULL,
  `fax_perusahaan` varchar(15) NOT NULL,
  `email_perusahaan` varchar(50) NOT NULL,
  `aktivitas_perusahaan` varchar(75) NOT NULL,
  `produk_perusahaan` varchar(75) NOT NULL,
...
INSERT INTO `tb_perusahaan` (`id_perusahaan`, `nama_perusahaan`, `lengkap_perusahaan`, `npwp_perusahaan`, `alamat_perusahaan`, `map_perusahaan`, `id_jenis`, `kelas_perusahaan`, `id_provinsi`, `id_kota`, `id_kecamatan`, `lokasi_perusahaan`, `kodepos_perusahaan`, `web_perusahaan`, `desk_perusahaan`, `penanggung_perusahaan`, `telp_perusahaan`, `fax_perusahaan`, `email_perusahaan`, `aktivitas_perusahaan`, `produk_perusahaan`, `association`, `logo_perusahaan`, `password_perusahaan`, `confirm_password_perusahaan`, `date_created`) VALUES
(22, 'UD Maju', 'UD Kirin', '98797978779', 'waswawawawawaw', 'https://www.google.com/maps/place/Ayam+Goreng+Nelongso+Mastrip+Jember/@-8.1641678,113.7242549,16.75z/data=!4m5!3m4!1s0x2dd695cf27181faf:0xf78d065b26a0c618!8m2!3d-8.1665196!4d113.7247851', 6, 'Menengah', 17, 1701, 1701040, 1, 8088, 'Maju.com', 'UD Maju', 'Nur HD', '0878677565', '9868567575', 'maju@gmail.com', 'Dagang', 'Jaket', 'Asosiasi Dagang', '2020_02_09_14_42_19webp', '698d51a19d8a121ce581499d7b701668', '698d51a19d8a121ce581499d7b701668', '2020-02-09'),
(24, 'Ady Bagus Sugih Susanto', 'Ady Bagus Sugih Susanto', '111', 'asassa', 'https://www.google.com/maps/place/Polsek+Rogojampi/@-8.3170116,114.2984855,15z/data=!4m5!3m4!1s0x2dd1572cbd4d5579:0x6132874cdbd38b00!8m2!3d-8.3126855!4d114.2901975', 4, 'Menengah', 35, 3507, 3507020, 2, 123, 'asdasd.com', 'asdasd', 'asdasd', '0878677565', '9868567575', 'sas@gnma.com', 'asdasd', 'asdasd', 'asdasd', '2020_02_29_08_10_16jpg', 'b2ca678b4c936f905fb82f2733f5297f', 'b2ca678b4c936f905fb82f2733f5297f', '2020-02-29');
...
CREATE TABLE `tb_tingkatpdd` (
  `id_tingkatpdd` int(2) NOT NULL,
  `jenis_tingkatpdd` varchar(15) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `tb_workshop` (
  ...
  `maps_workshop` text NOT NULL,
  `tanggal_workshop` date NOT NULL,
  `str_workshop` date NOT NULL,
  `end_workshop` date NOT NULL,
...
--
-- Indexes for table `tb_data_pelaku_usaha`
--
...
--
-- AUTO_INCREMENT for table `tb_data_pelaku_usaha`
--
ALTER TABLE `tb_data_pelaku_usaha`
...
--
ALTER TABLE `tb_perusahaan`
  MODIFY `id_perusahaan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;
